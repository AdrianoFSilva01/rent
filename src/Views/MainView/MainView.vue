        ...
        <div class="relative flex w-full h-40 justify-center opacity-0 z-10" style="animation-delay: 0.5s" v-in-viewport="'fade-animation'">
            <div class="absolute flex -top-28 w-4/5 h-full bg-white border-4 border-gold items-center space-x-10 px-10">
                <div class="dropdown-container">
                    ...
                    <div>
                        <Dropdown dropdown-text="From" v-model="selectedDay" @open-component="reset" class="dropdown">
                ...
                <div class="dropdown-container">
                    ...
                    <div>
                        <Dropdown
                            dropdown-text="Number Of Guests"
                            v-model="selectedPersons"
                            :source="persons"
                            class="dropdown"
                            style-class="bg-white border border-gray-400 hover:border-gold hover:text-gold pl-2 py-0.5 cursor-pointer"
                        >
                            <svg class="w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
